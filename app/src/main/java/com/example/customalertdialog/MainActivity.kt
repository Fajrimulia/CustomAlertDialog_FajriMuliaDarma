...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnkenalan = findViewById<Button>(R.id.btkenalan)
        ...
        btnkenalan.setOnClickListener {
            ...
            val ald = AlertDialog.Builder(this@MainActivity)
            with(ald){
                ...
                setNeutralButton("Maaf, cuma numpang lewat", null)//Tidak ada feedback dari aplikasih
                create().show()
            }
        }
    }
